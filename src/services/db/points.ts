...
import { doc, getDoc, setDoc, collection, DocumentData, QueryDocumentSnapshot, SnapshotOptions } from "firebase/firestore";
...
const getDocRef = (userId: string) => {
    return doc(firebaseDb, COLLECTION_NAME, userId).withConverter(pointsConverter);
}
